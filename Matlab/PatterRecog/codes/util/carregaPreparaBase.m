%Configurações
opc = {'iris','vertebra','derme','breastC'};
nomeBases = {'iris','Vertebra','Dermatologia','Cancer de mama'};
...
[p,v] = listdlg('PromptString','Selecione as Caracteristicas:','SelectionMode','multiple','ListString',opc)
if(~v || length(p)<2) 
      return;
end;
