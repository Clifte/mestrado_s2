...
\begin{figure}
	\centering
	\begin{tabular}{cc}
	  \includegraphics[width=70mm]{figuras/decRegK1.eps} &  
	  \includegraphics[width=70mm]{figuras/decRegK5.eps}
	  \\
	(a) k=1 & (b) k=5 \\[6pt]
	 \includegraphics[width=70mm]{figuras/decRegK50.eps} &  
	 \includegraphics[width=70mm]{figuras/decRegK100.eps} \\
	(c) k=50 & (d) k=100 \\[6pt] 
